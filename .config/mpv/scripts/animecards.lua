...
local FRONT_FIELD = "単語"
local SENTENCE_AUDIO_FIELD = "例文音声"
local SENTENCE_FIELD = "例文"
local IMAGE_FIELD = "画像"
...
local function get_forvo_audio(word)
  ...
  if platform == 'windows' then
    args = {
      'powershell', '-NoProfile', '-Command', [[& {
      $data = Invoke-WebRequest -Uri "https://forvo.com/search/]] .. word .. [[/ja/" -Headers @{
    "method"="GET"
      "authority"="forvo.com"
      "scheme"="https"
